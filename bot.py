...
# PATCH15.1: Telegram custom emoji.
# Работает только в HTML-сообщениях. В кнопках оставляем обычные emoji, чтобы не показывать raw HTML.
CUSTOM_EMOJI_IDS = {
...
SECTION_HINTS = {
    ...
    "rules": (f"{CE['rules']} Правила", "Короткие правила мультивселенной без скучной стены текста."),
...
async def send_rules(message):
    await message.answer(
        ...
        f"{CE['pistachios']} <b>Фисташки</b>\n"
        "Обычная валюта: сундуки, крафт, часть улучшений и награды.\n\n"
        f"{CE['dragonite']} <b>Драконит</b>\n"
