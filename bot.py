...
async def send_shop(message, user):
    ...
    await message.answer(
        ...
        f"{DRAGONITE_LABEL}: <b>{p.get('moon_coins', 0)}</b>\n\n"
        "🆓 Бесплатный сундук — персонаж каждые 3 часа.\n"
        "📅 Ежедневная награда — ресурсы, pass XP и шанс на редкий бонус.\n"
        "🧰 Сундуки — обычные, усиленные и королевские открытия.\n"
        "🎟 Мультипасс / Донат — Stars, pass, кейсы, промокоды и уровни.\n"
        "🏆 Рейтинг — сила игроков и место в мультивселенной.",
...
async def send_modes(message, user):
    ...
    await message.answer(
        f"{ui_box(title, body)}\n\n"
        "⚔️ <b>Арена</b> — одиночный бой на поле, где арена даёт бонусы и режет слабые стороны.\n"
        "🌐 <b>Онлайн</b> — PvP против живого игрока: решают колода, выбор первого бойца и тактика.\n"
        "🃏 <b>Колоды</b> — собери пятёрку персонажей под роль, синергию и стиль боя.\n"
        "🎪 <b>Ивенты</b> — временные события, кейсы, задания дня и редкие награды.\n"
        "👹 <b>Рейд</b> — общий босс мультивселенной, рейтинг урона и финальные призы.\n\n"
