...
ok("main_stats_inside_blockquote", main.count("<blockquote>")==1 and main.count("</blockquote>")==1 and "Призывы: <b>8</b>" in main)
ok("main_menu_compact", "Персонажи:" not in main and "Ежедневная:" not in main and "MultiPass" not in main and "Сезон" not in main)
